...
The \boatvone\ annotation tool was developed for annotating dependency relations, which was used to create the manually annotated \bountreebank{} (UD\_Turkish-BOUN) of Turkish National Corpus (TNC).
...
This paper discusses the requirements, design, implementation of \boatvtwo\ with annotation examples that highlight the new features.
\end{abstract}
