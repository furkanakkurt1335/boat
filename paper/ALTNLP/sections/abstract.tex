\begin{abstract}
    ...
    \boatvone\ was developed for annotating dependency relations and was subsequently used to create the manually annotated \bountreebank\ (UD\_Turkish-BOUN)~\cite{ud-turkish-boun}.
