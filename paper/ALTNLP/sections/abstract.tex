...
The annotation tool \boatvone\ was developed for annotating dependency relations and subsequently was used to create the manually annotated \bountreebank{} (UD\_Turkish-BOUN) of Turkish National Corpus (TNC).
