...
These tools mostly rely on mouse-based user interaction, which tend to be inefficient for annotating MRLs because they require lots of entries of features of forms.
Another tool is WebAnno~\cite{webanno} which supports multiple users and is also web-based, similar to \boatvtwo and it relies on mouse interactions. % add citation for WebAnno
