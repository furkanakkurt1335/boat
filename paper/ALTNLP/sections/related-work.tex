...
Although mouse input is supported for most tasks, for almost all functionality, keyboard input is supported.
...
To annotate features of a token, it requires many clicks which makes it impractical, especially for MRLs.
...
The work presented in this paper (\boatvtwo) is based on the experiences from \boatvone\ with continuous feedback from an annotator.
