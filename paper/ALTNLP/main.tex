...
Tools to support dependency parsing annotations have been developed. % citations from related work
...
% drag drop, flow state, disrupt interrupt
% boat had significant improvement on efficiency

% BoAT desktop used for BOUN Treebank
...
% busra'dan ornek; kisa (ya da uzun gerekiyorsa); sor bugun 4/22
