...
% other languages
% tools to preprocess sentences (NLP, etc)
% specific communication with annotators, question answer
% rules, automated support to relieve annotator from labor intensive manual tasks
