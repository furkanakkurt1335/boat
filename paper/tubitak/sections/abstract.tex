\begin{abstract}
    ...
    Boğaziçi University Annotation Tool-{\scriptsize v1} (\boat) was developed for annotating dependency relations and was subsequently used to create the manually annotated \bountreebank\ (UD\_Turkish-BOUN).
