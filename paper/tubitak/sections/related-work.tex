...
\begin{table}[ht!]
    ...
    \begin{tabular}{|s|>{\centering\arraybackslash} p{2.8cm}|>{\centering\arraybackslash} p{3cm}|>{\centering\arraybackslash} p{2.4cm}|>{\centering\arraybackslash} p{1.9cm}|>{\centering\arraybackslash} p{1.2cm}|>{\centering\arraybackslash} p{2cm}|}
       \hline
        \rowcolor[HTML]{FFFAF0} \multicolumn{7}{|c|}{\textbf{Comparison of Annotation Tools}} \\ \hline\hline
        \multicolumn{1}{|c|}{\cellcolor[HTML]{FFFAF0} \textbf{Tool}} & \textbf{Multi-language} & \textbf{Modality} & \textbf{Standards} & \textbf{Multi-user} & \textbf{Search} & \textbf{Automation} \\\hline
